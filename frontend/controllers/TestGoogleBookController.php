...
class TestGoogleBookController extends \yii\web\Controller {

    /**
     * Questo è solo un test DEMO di Google Api PHP client
     * Visualizza l'elenco dei libri di una ricerca su Google Books
     * Attenzione: senza modello dati
     */
    public function actionIndex() {
        //recupera l'eventuale ricerca da form
        ...
        $client->setApplicationName("bookswapp");
        $client->setDeveloperKey(Yii::$app->params['GoogleDeveloperKey']);

        $service = new Google_Service_Books($client);
        // $optParams = array('filter' => 'free-ebooks');
        //$results = $service->volumes->listVolumes('database mysql', $optParams);
        $results = $service->volumes->listVolumes($search);

        //chiama view/test-google-book/index.php
