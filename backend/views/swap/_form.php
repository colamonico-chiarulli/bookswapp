...
<div class="swap-form">
    ...
    <?= $form->field($model, 'seller_user_id')->textInput() ?>

    <?= $form->field($model, 'buyer_user_id')->textInput() ?>

    <?= $form->field($model, 'price_swap')->textInput(['maxlength' => 8]) ?>

    <?= $form->field($model, 'annexes_swap')->textInput() ?>

    <?= $form->field($model, 'sold')->textInput() ?>

    <?= $form->field($model, 'note_swap')->textInput(['maxlength' => 255]) ?>
