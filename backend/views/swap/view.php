...
<div class="swap-view">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->id, 'book_id' => $model->book_id, 'condition_id' => $model->condition_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->id, 'book_id' => $model->book_id, 'condition_id' => $model->condition_id], [
