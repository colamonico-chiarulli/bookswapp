...
/* @var $model common\models\PrintType */

$this->title = Yii::t('app', 'Create Print Type');
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Print Types'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="print-type-create">
