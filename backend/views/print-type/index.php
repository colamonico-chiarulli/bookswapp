...
/* @var $searchModel backend\models\search\PrintTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Print Types');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="print-type-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Print Type'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
