...
use backend\models\search\SwapSearch;
...
class SwapController extends Controller
{
     ...
     * @return mixed
     */
    public function actionView($id, $book_id, $condition_id)
    {
        return $this->render('view', [
            'model' => $this->findModel($id, $book_id, $condition_id),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->id, 'book_id' => $model->book_id, 'condition_id' => $model->condition_id]);
        } else {
     ...
     * @return mixed
     */
    public function actionUpdate($id, $book_id, $condition_id)
    {
        $model = $this->findModel($id, $book_id, $condition_id);
     ...
     * @return mixed
     */
    public function actionDelete($id, $book_id, $condition_id)
    {
        $this->findModel($id, $book_id, $condition_id)->delete();
     ...
     */
    protected function findModel($id, $book_id, $condition_id)
    {
        if (($model = Swap::findOne(['id' => $id, 'book_id' => $book_id, 'condition_id' => $condition_id])) !== null) {
            return $model;
        } else {
