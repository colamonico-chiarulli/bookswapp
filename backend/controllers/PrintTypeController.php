...
use Yii;
use common\models\PrintType;
use backend\models\search\PrintTypeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * PrintTypeController implements the CRUD actions for PrintType model.
 */
class PrintTypeController extends Controller
{
    ...
    /**
     * Lists all PrintType models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new PrintTypeSearch();
    ...
    /**
     * Displays a single PrintType model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing PrintType model.
    ...
    /**
     * Deletes an existing PrintType model.
    ...
    /**
     * Finds the PrintType model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return PrintType the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = PrintType::findOne($id)) !== null) {
            return $model;
        } else {
