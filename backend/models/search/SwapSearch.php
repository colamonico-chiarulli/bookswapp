...
/**
 * SwapSearch represents the model behind the search form about `common\models\Swap`.
 */
class SwapSearch extends Swap
{
    ...
    {
        return [
            [['id', 'seller_user_id', 'buyer_user_id', 'annexes_swap', 'sold', 'book_id', 'condition_id'], 'integer'],
            [['price_swap'], 'number'],
