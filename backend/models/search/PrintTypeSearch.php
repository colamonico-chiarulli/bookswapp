...
/**
 * PrintTypeSearch represents the model behind the search form about `common\models\PrintType`.
 */
class PrintTypeSearch extends PrintType
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'print_type', $this->print_type]);
